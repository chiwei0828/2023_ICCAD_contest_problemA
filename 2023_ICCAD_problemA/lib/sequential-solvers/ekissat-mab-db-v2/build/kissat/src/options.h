...
OPTION (cdphaseaction, 1, 1, 10, "option for triggering a rule for handling substantial cd phases") \
OPTION (cdphaseactionh, 0, 0, 1, "option for triggering a rule for handling substantial cd phases") \
...
OPTION( substantialcdfactor, 15, 0, 100, "fator to determine a substantial cd phase") \
