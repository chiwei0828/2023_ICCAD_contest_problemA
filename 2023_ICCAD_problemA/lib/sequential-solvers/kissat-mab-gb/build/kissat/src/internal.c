...
{
  solver->is_glue_var_chb = calloc(solver->vars,sizeof(bool)); 
  solver->is_decision_chb = calloc(solver->vars,sizeof(bool)); 
  ...
  solver->is_glue_var_vsids = calloc(solver->vars,sizeof(bool)); 
  solver->is_decision_vsids = calloc(solver->vars,sizeof(bool)); 
