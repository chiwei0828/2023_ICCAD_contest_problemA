...
walking_phase (kissat * solver)
{
  ...
  if (walk_time == 1){
    ...
    AVG_LEN = AVG_LEN / ((double) NCLS);
    double CLS_TO_VAR = ((double) NCLS) / ((double) NVARS);
    
    selected_strategy = select_strategy_by_decision_tree(solver, NVARS, NCLS, CLS_TO_VAR, MIN_LEN, AVG_LEN, MAX_LEN);
  }
  ...
  if (selected_strategy == 3){
    ...
    int new_rounds = 5 * max_rounds;
    for (unsigned round = 1; walker.minimum && round <= new_rounds; round++)
      {
        if (TERMINATED (24))
  	break;
...
int
select_strategy_by_decision_tree(kissat * solver, int NVARS, int NCLS, double CLS_TO_VAR, int MIN_LEN, double AVG_LEN, int MAX_LEN)
{
  if (CLS_TO_VAR <= 8.025) {
      if (NCLS <= 202867.5) {
          if (NCLS <= 3189.5) {
              ...
              else if (NVARS <= 14897.5)
                  return 2;
              return 1;
          }
          else if (CLS_TO_VAR <= 6.049) {
              if (CLS_TO_VAR <= 0.928) {
                  if (AVG_LEN <= 66.479) {
                      if (MAX_LEN <= 164.5)
                          return 3;
                  ...
                  else if (CLS_TO_VAR <= 0.123)
                      return 2;
                  return 3;
              }
              else if (AVG_LEN <= 3.974) {
                  if (MAX_LEN <= 356.5) {
                      if (NVARS <= 28731)
                          return 1;
                      return 2;
                      ...
                      return 1;
                  else if (NVARS <= 90073.5)
                      return 2;
                  return 3;
              }
              else if (AVG_LEN <= 35.882) {
                  if (NVARS <= 124578.5) {
                      if (CLS_TO_VAR <= 2.797) {
                          if (AVG_LEN <= 7.381) {
                              if (AVG_LEN <= 5.328)
          ...
          else if (AVG_LEN <= 3.984)
              return 1;
          else if (MAX_LEN <= 103.5) {
              if (NCLS <= 12860) {
                  if (NVARS <= 1230.5)
                      return 2;
                  return 3;
      ...
      else if (CLS_TO_VAR <= 3.504) {
          if (AVG_LEN <= 3.632) {
              if (MAX_LEN <= 528.5)
                  return 1;
              else if (MAX_LEN <= 9899.5)
                  return 2;
              return 1;
          }
          else if (CLS_TO_VAR <= 1.419)
              return 1;
          else if (MAX_LEN <= 8882) {
              if (AVG_LEN <= 3.681)
                  return 3;
              return 2;
          }
      ...
      else if (AVG_LEN <= 3.751)
          return 2;
      else if (CLS_TO_VAR <= 4.287)
          return 1;
      return 2;
  }
  else if (NCLS <= 26568.5) {
      if (CLS_TO_VAR <= 26.614) {
          if (MAX_LEN <= 101.5) {
              if (AVG_LEN <= 6.921) {
                  if (CLS_TO_VAR <= 9.748) {
                      if (AVG_LEN <= 6.532) {
                  ...
                  else if (NCLS <= 22405.5)
                      return 1;
                  else if (NCLS <= 23291.5)
                      return 2;
                  return 1;
              }
              else if (CLS_TO_VAR <= 11.075)
                  return 2;
              else if (NCLS <= 3098.5)
                  return 1;
              else if (NVARS <= 320.5) {
              ...
              else if (AVG_LEN <= 9.139)
                  return 3;
              else if (NCLS <= 4623.5)
                  return 3;
              return 2;
          }
          else if (AVG_LEN <= 7.558) {
              if (NCLS <= 13339.5)
                  return 1;
              else if (NCLS <= 16595) {
                  if (MAX_LEN <= 102.5)
                      return 2;
                  else if (NCLS <= 13396.5)
                      return 2;
                  return 3;
              }
              return 2;
  ...
  else if (MAX_LEN <= 134.5) {
      if (NVARS <= 324943.5) {
          if (MIN_LEN <= 4.5) {
              if (MAX_LEN <= 95.5)
                  return 1;
              else if (CLS_TO_VAR <= 16.712) {
                  if (NCLS <= 49894)
                      return 1;
                  return 2;
              }
  ...
  else if (AVG_LEN <= 3.385) {
      if (CLS_TO_VAR <= 24.935)
          return 2;
      return 1;
  }
  else if (AVG_LEN <= 5.935)
      return 3;
  return 1;
}
