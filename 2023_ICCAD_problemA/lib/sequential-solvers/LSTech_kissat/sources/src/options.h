...
OPTION( ccanr, 1, 0, 1, "allow ccanr") \
OPTION( ccanr_dynamic_bms, 20, 0, 10000, "bms*10") \
OPTION( ccanr_gap_inc, 5040, 0, 100000, "restart gap inc") \
...
OPTION( heuristic_focus, 0, 0, 2, "scoring heuristic (0=VMTF,1=LRB,2=chb)") \
...
OPTION( phaseprob1, 177, 0, 1000, "ls best") \
OPTION( phaseprob2, 230, 0, 1000, "ls mediation") \
OPTION( phaseprob3, 436, 0, 1000, "ls target") \
OPTION( phaseprob4, 3 , 0, 1000, "invert now") \
OPTION( phaseprob5, 25 , 0, 1000, "invert best") \
OPTION( phaseprob6, 30 , 0, 1000, "invert mediation") \
OPTION( phaseprob7, 50, 0, 1000, "random") \
...
OPTION( rephaseinit, 54, 10, 1e5, "initial rephase interval") \
OPTION( rephaseint, 54, 10, 1e5, "base rephase interval") \
OPTION( rephaseprob_best, 32, 0, 100, "rephase prob para") \
OPTION( rephaseprob_flip, 9, 0, 100, "rephase prob para") \
OPTION( rephaseprob_invert, 9, 0, 100, "rephase prob para") \
OPTION( rephaseprob_original, 9, 0, 100, "rephase prob para") \
OPTION( rephaseprob_random, 9, 0, 100, "rephase prob para") \
OPTION( rephaseprob_walk, 32, 0, 100, "rephase prob para") \
OPTION( rephasetype, 0, 0, 1, "rephase type(0=target_rephase,1=rand_rephase)") \
...
OPTION( targetinc, 90, 0, 100, "target inc") \
