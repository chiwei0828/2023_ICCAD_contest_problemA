...
OPTION( walkccnr, 1, 0, 1, "use ccnr algorithm") \
OPTION( walkccnrreward, 50, 0, 1000, "conflict reward coefficient to VSIDS") \
OPTION( walkeffort, 700, 0, 1e6, "effort in per mille") \
...
OPTION( walkup, 0, 0 ,1 , "use UP initial") \
