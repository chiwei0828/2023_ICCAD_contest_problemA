...
#define OPTIONS \
OPTION( aa_freeze_bump, 20, 0, INT_MAX, "freeze_bump") \
OPTION( aa_freeze_ils, 100, 0, INT_MAX, "freeze_ils")  \
OPTION( aa_freeze_exp, 50, 0, INT_MAX, "freeze_exp")  \
OPTION( aa_trans_confl, 100, 0, INT_MAX, "trans_confl") \
...
OPTION( mS, 5, 3, 10, "num step of exploration")       \
OPTION( mW, 5, 3, 10, "num walk of exploration") \
OPTION( otfs, 1, 0, 1, "on-the-fly strengthening")     \
OPTION( para_expScore, 50, 10, 100, "parameter of exploration score in the variable score")\
